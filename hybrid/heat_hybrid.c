 ...
 * 
 * Combines MPI for inter-process communication (distributed memory)
 * and OpenMP for intra-process parallelism (shared memory).
 * Grid is decomposed into horizontal slices across MPI processes,
 * and each process uses OpenMP to parallelize computation within its slice.
 */
...
int main(int argc, char *argv[]) {
    ...
    for (int t = 0; t < timesteps; t++) {
        ...
        // Update interior cells using OpenMP
